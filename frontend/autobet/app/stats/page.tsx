          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            <div className="space-y-3 max-w-2xl">
              ...
              <p className="text-sm text-neutral-300 leading-relaxed">
                Только то, на что бот реально ставит: разрешённые спорты и рынки, кэф 1.5–2.0,
                достаточный EV и поддержка рынка. Вердикт сети против фактического исхода —
                по виду спорта и типу ставки («П1», «Тотал Больше 2.5» и т.д.).
              </p>
            </div>
