...
class DeepSeekWebClient:
    ...
    def solve_pow(self, challenge_str: str, prefix: str, difficulty: float) -> int:
...
def main():
    ...
    print(f"📡 Подключение к веб-версии DeepSeek (chat.deepseek.com)...")
    print(f"💬 Запрос: '{prompt}'\n")

    client = DeepSeekWebClient()
    answer = client.send_message(prompt)

    print("=====================================================")
    print(" 🤖 ОФИЦИАЛЬНЫЙ ОТВЕТ DEEPSEEK WEB UI:")
    print("=====================================================\n")
    print(answer)
    print("\n=====================================================")
